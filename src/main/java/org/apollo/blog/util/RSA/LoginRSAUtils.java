...
public class LoginRSAUtils {
    ...
    public static void setRedisTemplate(RedisTemplate<String, Object> redisTemplate) {
        LoginRSAUtils.redisTemplate = redisTemplate;
    }
     ...
     * 用来指定保存密钥对的文件名和存储的名称
     */
    private static final String PUBLIC_KEY = "apollo:login:RSAPublicKey";
    private static final String PRIVATE_KEY = "apollo:login:RSAPrivateKey";
    ...
    private static String getKeyString(String keyName) {
        if (redisTemplate.hasKey(keyName)) {
            ...
            try {
                ...
                log.error("生成密钥失败! 信息:{}", e.getMessage(), e);
                return null;
            }
            return getKeyString(keyName);
        }
    }

    public static String getPublicKeyString() {
        return getKeyString(PUBLIC_KEY);
    }

    public static String getPrivateKeyString() {
        return getKeyString(PRIVATE_KEY);
    }
    ...
    public static void genKeyPair() throws Exception {
        ...
        storeKey(publicKeyString, PUBLIC_KEY);
        storeKey(privateKeyString, PRIVATE_KEY);
    }
